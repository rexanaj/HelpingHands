...
describe("Routes", () => {
  ...
  it("GET /articles?limit=10&start_date=2022-02-03T23:59:59 ==> successful", async () => {
    const res = await supertest(app).get("/articles?limit=10&start_date=2022-02-03T23:59:59");
    //five articles in the database have dates later than provided start date
    //convert start date query into unix timestamp
    var unixStartDate = Date.parse("03-Feb-2022 23:59:59")/1000;
