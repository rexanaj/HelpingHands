    ...
    <div>
      ...
      <div className="government-hotline">
        <div className="gov-box">
          ...
          <div className="gov-body">
            <div className="icon-text">
              <img src={callIcon}></img> +41 22 791 21 11
            </div>
            <div className="icon-text">
              <img src={emailIcon}></img> https://www.who.int/about/contact-us
            </div>
          </div>
        </div>
        <div className="gov-box">
          ...
          <div className="gov-body">
            <div className="icon-text">
              <img src={callIcon}></img> 1800 232 4636
            </div>
            <div className="icon-text">
        ...
        <div className="gov-box">
          ...
          <div className="gov-body">
            <div className="icon-text">
              <img src={callIcon}></img> 02 8570 2600
            </div>
            <div className="icon-text">
              <img src={emailIcon}></img> https://www.msf.org/contact-us
            </div>
          </div>
        </div>
      </div>
      {loading ? (
        <Container sx={{ py: 8 }} id="gethelp-card-container">
          ...
          <Button
            id="advice-button"
            startIcon={<Avatar src={addIcon} id="icon" />}
            onClick={handleOpen}
          >
            Add advice
          </Button>
